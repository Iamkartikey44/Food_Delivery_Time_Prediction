...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        model_signature = mlflow.models.infer_signature(model_input=X_train.sample(20,random_state=42),model_output=model.predict(X_train.sample(20,random_state=42)))
